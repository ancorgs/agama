  ...
  module Storage
    ...
    class System
      ...
      def candidate_drives
        available_drives.reject { |d| d.is?(:stray_blk_device) }
      end
      ...
      def available_md_raids
        ...
        devicegraph.software_raids.select { |d| analyzer.candidate_device?(d) }
      end
      ...
      def candidate_md_raids
        ...
        devicegraph.software_raids.select { |d| analyzer.candidate_software_raid?(d) }
      end
